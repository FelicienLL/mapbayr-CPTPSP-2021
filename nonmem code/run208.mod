...
$DATA data_to_fit208.csv IGNORE=@
...
$TABLE ID TIME EVID AMT CMT II ADDL RATE MDV DV S2_SAMPLING PRED IPRED NOPRINT NOAPPEND ONEHEADER FORMAT=s1PE16.8E3 FILE=run208.tab
