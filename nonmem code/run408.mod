$PROBLEM EXAMPLINIB1
$INPUT ID TIME EVID AMT CMT II ADDL RATE MDV NDV DV S2_SAMPLING
$DATA data_to_fit408.csv IGNORE=@
...
$TABLE ID TIME EVID AMT CMT II ADDL RATE MDV NDV DV S2_SAMPLING NIPRED PRED IPRED NOPRINT NOAPPEND ONEHEADER FORMAT=s1PE16.8E3 FILE=run408.tab
